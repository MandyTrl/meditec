...
import notation from "@assets/sparkles.svg"
...
export const ResumeChart = () => {
	...
	const renderHospital = (el: ResumeHospital) => {
		return (
			<div
				key={el.name}
				className="group flex items-start hover:opacity-80 transition-all duration-150 ease-in-out gap-2 mb-2">
				<p className="font-medium transition-all duration-150 ease-in-out text-4xl flex items-center justify-center">
					{el.satisfactionRate}
				</p>
